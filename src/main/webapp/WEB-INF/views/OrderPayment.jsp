			...
			<div class="container" style="width:800px;margin:0 auto;">
				<form method="POST" action="<c:url value='/pay' />">
					<div class="col-50">
						...
						<input type="text" id="price" name="price" value="${orderList.price}">
						
						<label for="currency">幣種</label>
						<input type="text" id="currency" name="currency" placeholder="Enter Currency" value="TWD">
						...
						<label for="description">付款描述</label> <!-- 原字段:Payment Description -->
						<input type="text" id="description" name="description" placeholder="Payment Description" value="${orderList.description}">
...
<!-- 				</p> -->
<!-- 				<p> -->
<!-- 					<a href="#">Product 2</a> <span class="price">$4</span> -->
<!-- 				</p> -->
<!-- 				<p> -->
<!-- 					<a href="#">Product 3</a> <span class="price">$3</span> -->
<!-- 				</p> -->
<!-- 				<p> -->
...
<!-- 				<hr> -->
<!-- 				<p> -->
<!-- 					Total <span class="price" style="color: black"><b>$10</b></span> -->
<!-- 				</p> -->
<!-- 			</div> -->
<!-- 		</div> -->
	</div>
