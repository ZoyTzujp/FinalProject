...
<!--                                     <option value="6">Product Name: Z</option> -->
         ...
         <script>
             ...
             selectElement.onchange = function(){
            	 location.href ="<c:url value='/showProductCooperateForm' />"
...
============================================ -->
    ...
    <!-- Bootstrap JS -->
    <script src="<c:url value='assets/js/vendor/bootstrap.bundle.min.js' />"></script>
    <!-- Slick Slider JS -->
    <script src="<c:url value='assets/js/plugins/slick.min.js' />"></script>
    <!-- Countdown JS -->
    <script src="<c:url value='assets/js/plugins/jquery.countdown.min.js' />"></script>
    <!-- Ajax JS -->
    <script src="<c:url value='assets/js/plugins/jquery.ajaxchimp.min.js' />"></script>
    <!-- Jquery Nice Select JS -->
    <script src="<c:url value='assets/js/plugins/jquery.nice-select.min.js' />"></script>
    <!-- Jquery Ui JS -->
    <script src="<c:url value='assets/js/plugins/jquery-ui.min.js' />"></script>
    <!-- jquery magnific popup js -->
    <script src="<c:url value='assets/js/plugins/jquery.magnific-popup.min.js' />"></script>
